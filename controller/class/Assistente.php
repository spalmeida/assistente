...
class Assistente{
	...
	function __construct($busca, $assistente, $quest, $system_user){
		$this->conn 		= $busca;
		$this->assistente 	= $assistente;
		$this->time 		= date('H:i');
		$this->key 			= $busca->Rand(20);
		$this->quest 		= $quest;
		$this->pergunta		= $busca->select("perguntas", "pergunta_name = '$quest'  order by rand() limit 1");
		$this->user_name	= $system_user['0']['user_name'];
		$this->assist_name  = $assistente['0']['assistente_name'];
	}
	...
	function Resposta(){
		...
		<div class="font-weight-semibold mb-1">'.$assist_name.'
